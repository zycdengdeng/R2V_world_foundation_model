...
class ControlVideo2WorldCondition(Video2WorldCondition):
    ...
    control_input_blur: Optional[torch.Tensor] = None  # Custom control for blur projection
    ...
    control_input_blur_mask: Optional[torch.Tensor] = None  # Custom control mask for blur
